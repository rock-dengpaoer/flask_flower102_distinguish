...
def main():
    ...
    # transform = timm_data.create_transform(
    ...
    test_datasets = torchvision.datasets.ImageFolder(root="data/test", transform=None)
    # print(test_datasets)

    
    
    # test_datasets = timm_data.create_dataset(name = "", root="data/test")
    test_datasets = timm_data.ImageDataset(root="data/test", transform=transform)
    # print(test_datasets)
    # # sys.exit()
